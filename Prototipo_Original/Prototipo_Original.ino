...
int d; // Quarto Led
int e; // Quinto Led
int f; // Gabarito Primeiro Led
int g; // Gabarito Segundo Led
int h; // Gabarito Terceiro Led
int i; // Gabarito Quarto Led
int j; // Gabarito Quinto Led
int buttonPressed[] = {0, 0, 0, 0};
int buttonState[] = {0, 0, 0, 0};
int button[] = {3, 4, 5, 8}; // 3-VM  4-VD  5-AM  6-AZ
int ledpin[] = {9, 10, 11, 12}; // 9-VM  10-VD  11-AM  12-AZ
int fim = 0;
...
int level = 0; // Variavel de níveis do jogo
...
for(int x=0; x<4; x++)  // Leds Output
  {
    pinMode(ledpin[x], OUTPUT);
  }
for(int x=0; x<4; x++) // Botões Input
  {
